...
class VisualizationFactory {
    ...
    visualizeSequenceDifferences(sequence1, sequence2, visualizationWidth = 1500,
        ...
        return this.visalusationManager.visualiseTwoMotionDifference(sequence1, sequence2, visualizationWidth, this.model,
            drawStyle, drawStyleBlur, contextOption, defaultContext, visualizationParts);
    }

    sampleData(sequences, sampleCount) {
        SampleManager.sampleDataSet(sequences, sampleCount, this.model)
    }
...
function resizeSkeleton(skeleton, drawStyle, figureScale) {
    figureScale = figureScale*(8/drawStyle.skeletonModel.defaultScale);
...
function modifySkeletonToFrame(skeleton, frame, drawStyle, xShift, yShift, figureScale) {
    let vecNose = calculateNoseVector(frame[drawStyle.headIndex], frame[drawStyle.thoraxIndex], frame[drawStyle.leftArmIndex], 6*figureScale*(8/drawStyle.skeletonModel.defaultScale));
